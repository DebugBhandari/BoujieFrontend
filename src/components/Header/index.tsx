...
export default function Header() {
  ...
  return (
   <div className="navbar" style={style}>
       <div className="title">
       <Link to="/" style={{ textDecoration: 'none' }}><h1>Boujie Apparels</h1></Link>
       </div>
       ...
       <div className="sel">
        <select 
            ...
            <option value={themes.sub.color}>Sub</option>
           ...
           {!isAuthenticated ? 
            ...
            render={renderProps => (
              <button  className="dropbtn"  onClick={renderProps.onClick} disabled={renderProps.disabled}>Login</button>
            )}
            buttonText="Login"
