...
import {ShippingAddress, AppState, POST_ORDER,Product} from '../../types'
...
const total:number = products.reduce((acc:number,cart:Product)=> acc+cart.price*cart.quantity,0);
